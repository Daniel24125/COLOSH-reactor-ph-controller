...
import { Lock, Beaker, Save } from "lucide-react";
...
export function LiveSensorReading({ rawVoltage }: LiveSensorReadingProps) {
    return (
    ...
    return (
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 relative overflow-hidden group">
            <div className="flex items-center justify-between mb-4">
                ...
                {lockedVoltage !== null && <Lock className="w-4 h-4 text-emerald-500" />}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <div className="w-full bg-neutral-950 border border-neutral-800 rounded-lg px-4 py-2 text-neutral-200 font-mono">
                        {lockedVoltage !== null ? `${lockedVoltage.toFixed(4)} V` : "--- V"}
                    </div>
                </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-neutral-400 text-xs mt-1">
                        Slope: {slope.toFixed(4)} V/pH <br />
                        Intercept (pH 7): {intercept.toFixed(4)} V
                    </p>
                </div>
